...
public final class AMHConfig {
    ...
    private static final boolean DEFAULT_ENABLE_XAERO_MINIMAP_DIFFICULTY_DISPLAY = true;
    ...
    public static AMHConfig loadConfig() {
        ...
        defaultConfig.enableXaeroMinimapDifficultyDisplay = DEFAULT_ENABLE_XAERO_MINIMAP_DIFFICULTY_DISPLAY;
        ...
        if (!json.has("enableXaeroMinimapDifficultyDisplay")) {
            loaded.enableXaeroMinimapDifficultyDisplay = DEFAULT_ENABLE_XAERO_MINIMAP_DIFFICULTY_DISPLAY;
            changed = true;
        }
